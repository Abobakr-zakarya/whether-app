...
//shakl elkode bybka ahsan we ashal fe elfehem
      ...
      const weatherImages = {
        Clouds: { icon: "clouds.png", background: "clouds.jpg" },
        Clear: { icon: "clear.png", background: "clear.jpg" },
        Rain: { icon: "rain.png", background: "rain.jpg" },
        Drizzle: { icon: "drizzle.png", background: "drizzle.jpg" },
        Mist: { icon: "mist.png", background: "mist.jpg" },
      };
  
      weatherIcon.src = weatherImages[weatherMain].icon;
      body.style.background = `url('${weatherImages[weatherMain].background}') no-repeat center center fixed`;
      ...
      document.querySelector(".error").textContent = "Failed to fetch weather data. Please check your connection and try again.";
      document.querySelector(".error").style.display = "block";
